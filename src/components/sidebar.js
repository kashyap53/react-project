...
import applogo from "../images/zero-icon-logo.png";
            ...
            >
              ...
              >
                ...
                <a
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-prim
                  ry/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              ...
              >
                <ul className="flex flex-1 flex-col px-4 font-inter">
                  <li>
                    <a
                      x-data="navLink"
                      href="/"
                      className="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                ...
                <ul className="flex flex-1 flex-col px-4 font-inter">
                  <li x-data="accordionItem('menu-item-1')">
                    <a
                      className="expanded ? 'text-slate-800 font-semibold dark:text-navy-50' : 'text-slate-600 dark:text-navy-200  hover:text-slate-800  dark:hover:text-navy-50'"
                     
                      className="flex items-center justify-between py-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out"
                  ...
                  <li x-data="accordionItem('menu-item-2')">
                    ...
                    >
                      ...
                      <svg
                        className="expanded && 'rotate-90'"
                        xmlns="http://www.w3.org/2000/svg h-4 w-4 text-slate-400 transition-transform ease-in-out"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                    ...
                    <ul x-collapse x-show="expanded">
                      <li>
                        <a
                          ...
                          className="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50 flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4"
                        >
                          <div className="flex items-center space-x-2">
                            <div
                              className="h-1.5 w-1.5 rounded-full border border-current opacity-40"
                  ...
                  <li>
                    <a
                      ...
                      className="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50 flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out"
                    >
                      Personal
                    </a>
                  </li>
