...
const Signin = () => {
  ...
  return (
    ...
    <div className="grid w-full grow grid-cols-1 place-items-center min-h-100vh">
      <div className="w-full max-w-[26rem] p-4 sm:px-5">
        <div className="text-center">
          <img className="mx-auto" src={logo} alt="logo" width={150} />
          <div className="mt-4">
        ...
        <div className="card mt-5 rounded-lg p-5 lg:p-7">
          <form action="index.html">
            <label className="block">
              <span htmlFor="email">Username:</span>
            ...
            <div className="mt-4 text-center text-xs+">
              <p className="line-clamp-1">
                <span>Dont have Account?</span> <Link to={'Signup'} className="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">Create Account</Link>
              </p>
              <Link to={'Sidebar'}>Logned in</Link>
            </div>
          </form>
        </div>
      </div>
